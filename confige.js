...
config.URL = 'http://127.0.0.1:8080/'; // L'url publique de votre site (ex http://127.0.0.1:8080/ )
config.port = 8080; //Le port sur lequel l'app doit écouter

config.mongoDB = "mongodb://localhost/ninjadev"; //base de donnée mongoDB à utiliser
